 ...
 * 洋蓟作物
 */
public class ArtichokeCropBlock extends TomatoCropBlock {

    private static final int[] PHASE_DAYS = new int[]{2, 2, 1, 2, 1}; // Original growth phases, followed by the harvest sentinel.

...
public class WeaponRegistry {
    ...
    private static void registerAllWeapons() {
        ...
        // ============== 棍棒武器 ==============
        // Lv.2 - 初级
        register(WeaponData.builder("dragontooth_club")
            .type(WeaponType.CLUB).level(14).damage(80, 100).speed(0)
            .knockback(1.3).precision(0).critChance(0.02).critMultiplier(4.0)
            .skill1(WeaponSkillData.builder("dragontooth_club_jaw")
                .nameKey("stardewcraft.weapon.skill.dragontooth_club_jaw")
                .descriptionKeys("stardewcraft.weapon.skill.dragontooth_club_jaw.desc.1")
                .effectKey("stardewcraft.weapon.skill.dragontooth_club_jaw.effect.1")
                .damage(280).cooldown(8).icon(WeaponIcons.SKILL_DRAGONTOOTH_CLUB_1).build())
            .skill2(WeaponSkillData.builder("dragontooth_club_breath")
                .nameKey("stardewcraft.weapon.skill.dragontooth_club_breath")
                .descriptionKeys("stardewcraft.weapon.skill.dragontooth_club_breath.desc.1")
                .effectKey("stardewcraft.weapon.skill.dragontooth_club_breath.effect.1")
                .damage(560).cooldown(24).icon(WeaponIcons.SKILL_DRAGONTOOTH_CLUB_2).build())
            .build());
        register(WeaponData.builder("rapier")
            .type(WeaponType.SWORD).level(5).damage(15, 25).speed(2)
            .knockback(1.0).precision(0).critChance(0.02).critMultiplier(3.0)
            .skill1(WeaponSkillData.builder("rapier_riposte")
                .nameKey("stardewcraft.weapon.skill.rapier_riposte")
                .descriptionKeys("stardewcraft.weapon.skill.rapier_riposte.desc.1")
                .effectKey("stardewcraft.weapon.skill.rapier_riposte.effect.1")
                .damage(180).cooldown(6).icon(WeaponIcons.SKILL_RAPIER_1).build())
            .build());
        register(WeaponData.builder("the_slammer")
            .type(WeaponType.CLUB).level(9).damage(40, 55).speed(-2).defense(0)
            .knockback(1.5).precision(0).critChance(0.02).critMultiplier(3.0)
            .skill1(WeaponSkillData.builder("slammer_upheaval")
                .nameKey("stardewcraft.weapon.skill.slammer_upheaval")
                .descriptionKeys("stardewcraft.weapon.skill.slammer_upheaval.desc.1")
                .effectKey("stardewcraft.weapon.skill.slammer_upheaval.effect.1")
                .damage(200).cooldown(8).icon(WeaponIcons.SKILL_THE_SLAMMER_1).build())
            .skill2(WeaponSkillData.builder("slammer_rampage")
                .nameKey("stardewcraft.weapon.skill.slammer_rampage")
                .descriptionKeys("stardewcraft.weapon.skill.slammer_rampage.desc.1")
                .effectKey("stardewcraft.weapon.skill.slammer_rampage.effect.1")
        ...
        register(WeaponData.builder("dwarf_hammer")
            ...
            .skill1(WeaponSkillData.builder("dwarf_hammer_rebound")
                ...
                .descriptionKeys("stardewcraft.weapon.skill.dwarf_hammer_rebound.desc.1")
                .effectKey("stardewcraft.weapon.skill.dwarf_hammer_rebound.effect.1")
                .damage(300).cooldown(8).icon(WeaponIcons.SKILL_DWARF_HAMMER_1).build())
            .skill2(WeaponSkillData.builder("dwarf_hammer_faultline")
                .nameKey("stardewcraft.weapon.skill.dwarf_hammer_faultline")
                .descriptionKeys("stardewcraft.weapon.skill.dwarf_hammer_faultline.desc.1")
                .effectKey("stardewcraft.weapon.skill.dwarf_hammer_faultline.effect.1")
        ...
        register(WeaponData.builder("lead_rod")
            ...
            .skill1(WeaponSkillData.builder("lead_rod_press")
                ...
                .descriptionKeys("stardewcraft.weapon.skill.lead_rod_press.desc.1")
                .effectKey("stardewcraft.weapon.skill.lead_rod_press.effect.1")
                .damage(240).cooldown(10).icon(WeaponIcons.SKILL_LEAD_ROD_1).build())
            .build());
        register(WeaponData.builder("kudgel")
            .type(WeaponType.CLUB).level(6).damage(27, 40).speed(-1)
            .knockback(1.6).precision(0).critChance(0.02).critMultiplier(4.0)
            .skill1(WeaponSkillData.builder("kudgel_sweep")
                .nameKey("stardewcraft.weapon.skill.kudgel_sweep")
                .descriptionKeys("stardewcraft.weapon.skill.kudgel_sweep.desc.1")
                .effectKey("stardewcraft.weapon.skill.kudgel_sweep.effect.1")
                .damage(100).cooldown(12).icon(WeaponIcons.SKILL_KUDGEL_1).build())
            .build());
        register(WeaponData.builder("wood_club")
            .type(WeaponType.CLUB).level(3).damage(9, 16).speed(0)
            .knockback(1.5).precision(0).critChance(0.02).critMultiplier(3.0)
            .skill1(WeaponSkillData.builder("wood_club_whirl")
                .nameKey("stardewcraft.weapon.skill.wood_club_whirl")
                .descriptionKeys("stardewcraft.weapon.skill.wood_club_whirl.desc.1")
                .effectKey("stardewcraft.weapon.skill.wood_club_whirl.effect.1")
                .damage(200).cooldown(8).icon(WeaponIcons.SKILL_WOOD_CLUB_1).build())
            .build());
        register(WeaponData.builder("wood_mallet")
            .type(WeaponType.CLUB).level(4).damage(15, 24).speed(2)
            .knockback(1.3).precision(1).critChance(0.02).critMultiplier(3.0)
            .skill1(WeaponSkillData.builder("wood_mallet_leap")
                .nameKey("stardewcraft.weapon.skill.wood_mallet_leap")
                .descriptionKeys("stardewcraft.weapon.skill.wood_mallet_leap.desc.1")
                .effectKey("stardewcraft.weapon.skill.wood_mallet_leap.effect.1")
                .damage(200).cooldown(8).icon(WeaponIcons.SKILL_WOOD_MALLET_1).build())
            .build());
        ...
        register(WeaponData.builder("galaxy_hammer")
            ...
            .knockback(1.0)
            .critChance(0.02)
            .skill1(WeaponSkillData.builder("galaxy_hammer_starshock_sweep")
                .nameKey("stardewcraft.weapon.skill.galaxy_hammer_starshock_sweep")
                .descriptionKeys("stardewcraft.weapon.skill.galaxy_hammer_starshock_sweep.desc.1")
                .damage(200)
                .effectKey("stardewcraft.weapon.skill.galaxy_hammer_starshock_sweep.effect.1")
                .cooldown(7)
                .icon(WeaponIcons.SKILL_GALAXY_HAMMER_1)
                .build())
            .skill2(WeaponSkillData.builder("galaxy_hammer_starfall_quake")
                .nameKey("stardewcraft.weapon.skill.galaxy_hammer_starfall_quake")
                .descriptionKeys("stardewcraft.weapon.skill.galaxy_hammer_starfall_quake.desc.1")
                .damage(600)
                .effectKey("stardewcraft.weapon.skill.galaxy_hammer_starfall_quake.effect.1")
                .cooldown(22)
                .icon(WeaponIcons.SKILL_GALAXY_HAMMER_2)
                .build())
            .build());
        ...
        register(WeaponData.builder("infinity_gavel")
            ...
            .knockback(1.0)
            .critChance(0.02)
            .skill1(WeaponSkillData.builder("infinity_gavel_singularity_press")
                .nameKey("stardewcraft.weapon.skill.infinity_gavel_singularity_press")
                .descriptionKeys("stardewcraft.weapon.skill.infinity_gavel_singularity_press.desc.1")
                .damage(300)
                .effectKey("stardewcraft.weapon.skill.infinity_gavel_singularity_press.effect.1")
                .cooldown(7)
                .icon(WeaponIcons.SKILL_INFINITY_GAVEL_1)
                .build())
            .skill2(WeaponSkillData.builder("infinity_gavel_endless_pounding")
                .nameKey("stardewcraft.weapon.skill.infinity_gavel_endless_pounding")
                .descriptionKeys("stardewcraft.weapon.skill.infinity_gavel_endless_pounding.desc.1")
                .damage(100)
                .effectKey("stardewcraft.weapon.skill.infinity_gavel_endless_pounding.effect.1")
                .cooldown(30)
                .icon(WeaponIcons.SKILL_INFINITY_GAVEL_2)
                .build())
            .build());

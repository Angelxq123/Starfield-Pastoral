...
public final class NativeBigSlimeRenderer extends EntityRenderer<MineBigSlimeEntity> {
    private static final ResourceLocation MODEL = ResourceLocation.fromNamespaceAndPath(StardewCraft.MODID, "monster_native/big_slime.json");
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(StardewCraft.MODID, "textures/entity/monster_native/big_slime.png");

...
class PerformanceReportFormatterTest {
    ...
    void formatsCompleteReportInEnumOrder() {
        ...
        assertEquals(List.of(
            ...
            "PLAYER_LOGIN_SYNC_STAGE samples=0 avg=0.000ms p95=0.000ms p99=0.000ms max=0.000ms",
            ...
            "PLAYER_FULL_SYNC_REQUESTS=0",
            "PLAYER_FULL_SYNC_SENT=0",
            "PLAYER_FULL_SYNC_SKIPPED=0",
            "PLAYER_LOGIN_SYNC_ENQUEUED=0",
            "PLAYER_LOGIN_SYNC_STAGES=0",
            "PLAYER_LOGIN_SYNC_COMPLETED=0",

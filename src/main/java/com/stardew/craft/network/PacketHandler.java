...
public class PacketHandler {
    ...
    public static void register(RegisterPayloadHandlersEvent event) {
        ...
        registrar.playToServer(com.stardew.craft.pet.PetActionPayload.TYPE, com.stardew.craft.pet.PetActionPayload.CODEC, DailySettlementAccessGuard.gated(com.stardew.craft.pet.PetActionPayload::handle));
        ...
        registrar.playToServer(com.stardew.craft.animal.runtime.LivestockManagePayload.TYPE, com.stardew.craft.animal.runtime.LivestockManagePayload.CODEC, DailySettlementAccessGuard.gated(com.stardew.craft.animal.runtime.LivestockManagePayload::handle));
        ...
        registrar.playToServer(com.stardew.craft.animal.runtime.LivestockPurchasePayload.TYPE, com.stardew.craft.animal.runtime.LivestockPurchasePayload.CODEC, DailySettlementAccessGuard.gated(com.stardew.craft.animal.runtime.LivestockPurchasePayload::handle));
        ...
        registrar.playToServer(com.stardew.craft.network.payload.BuildingLedgerActionPayload.TYPE, com.stardew.craft.network.payload.BuildingLedgerActionPayload.CODEC, DailySettlementAccessGuard.gated(com.stardew.craft.network.payload.BuildingLedgerActionPayload::handle));
        ...
        registrar.playToServer(com.stardew.craft.network.payload.BuildingWorkRequestPayload.TYPE, com.stardew.craft.network.payload.BuildingWorkRequestPayload.STREAM_CODEC, DailySettlementAccessGuard.gated(com.stardew.craft.network.payload.BuildingWorkRequestPayload::handle));
        ...
        registrar.playToServer(com.stardew.craft.network.payload.BuildingPurchasePayload.TYPE, com.stardew.craft.network.payload.BuildingPurchasePayload.STREAM_CODEC, DailySettlementAccessGuard.gated(com.stardew.craft.network.payload.BuildingPurchasePayload::handle));
        ...
        registrar.playToServer(com.stardew.craft.network.payload.BuildingRotatePayload.TYPE, com.stardew.craft.network.payload.BuildingRotatePayload.CODEC, DailySettlementAccessGuard.gated(com.stardew.craft.network.payload.BuildingRotatePayload::handle));
        registrar.playToServer(com.stardew.craft.network.payload.BuildingDraftCancelPayload.TYPE, com.stardew.craft.network.payload.BuildingDraftCancelPayload.CODEC, DailySettlementAccessGuard.gated(com.stardew.craft.network.payload.BuildingDraftCancelPayload::handle));
        registrar.playToServer(com.stardew.craft.network.payload.BuildingPreviewRequestPayload.TYPE, com.stardew.craft.network.payload.BuildingPreviewRequestPayload.STREAM_CODEC, DailySettlementAccessGuard.gated(com.stardew.craft.network.payload.BuildingPreviewRequestPayload::handle));
        ...
        registrar.playToServer(
            ...
            DailySettlementAccessGuard.gated(SunroomTeaBushActionPayload::handle)
        );
        ...
        registrar.playToServer(com.stardew.craft.fishing.network.BobberSelectPayload.TYPE, com.stardew.craft.fishing.network.BobberSelectPayload.CODEC, DailySettlementAccessGuard.gated(com.stardew.craft.fishing.network.BobberSelectPayload::handle));
        ...
        registrar.playToServer(com.stardew.craft.fishing.network.FishingMotionInputPayload.TYPE,
                com.stardew.craft.fishing.network.FishingMotionInputPayload.STREAM_CODEC, DailySettlementAccessGuard.gated(com.stardew.craft.fishing.network.FishingMotionInputPayload::handle));
		registrar.playBidirectional(
			...
			DailySettlementAccessGuard.gated(com.stardew.craft.fishing.network.FishingUsePayload::handle)
		);
        ...
        registrar.playToServer(com.stardew.craft.combat.network.HeavyHammerInputPayload.TYPE,
                ...
                DailySettlementAccessGuard.gated(com.stardew.craft.combat.network.HeavyHammerInputPayload::handle));
        registrar.playToClient(
